  ...
  <div class="components-container">
    ...
    <el-form :model="proceso">
      <el-form-item label="Número de Expediente" :label-width="formLabelWidth" >
        <el-input v-model="proceso.radicado" 
        placeholder="Ingrese el número del radicado"
        :disabled="edicion"></el-input>
      </el-form-item>
      ...
      <el-form-item label="Estado" :label-width="formLabelWidth" >
        <el-input v-model="proceso.estado" 
      ...
      <el-form-item label="Causa" :label-width="formLabelWidth" >
        <el-select v-model="proceso.usuarioAsignado" placeholder="Seleccione una causa" :disabled="edicion">
          <el-option label="Causal 1" value="Causal 1"></el-option>
          <el-option label="Causal 2" value="Causal 2"></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="Siguiente etapa" :label-width="formLabelWidth" >
        <el-select v-model="proceso.usuarioAsignado" placeholder="Seleccione la etapa siguiente" :disabled="edicion">
          <el-option label="Etapa 1" value="Etapa 1"></el-option>
          <el-option label="Etapa 2" value="Etapa 2"></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item label="Tipo de sanción" :label-width="formLabelWidth" >
        <el-select v-model="proceso.tipoSancion" placeholder="Seleccione el tipo de Sanción" :disabled="edicion">
          <el-option label="Sanción 1" value="Sanción 1"></el-option>
          <el-option label="Sanción 2" value="Sanción 2"></el-option>
        </el-select>
      </el-form-item>

      <el-form-item label="Monto de la sanción" :label-width="formLabelWidth" >
        <el-input-number v-model="proceso.montoSancion" 
        placeholder="Ingrese el valor de la sanción"
        :disabled="edicion"></el-input-number>
      </el-form-item>
      ...
      <el-form-item label="Descisión del recurso" :label-width="formLabelWidth" >
        <el-select v-model="proceso.descisionRecurso" placeholder="Seleccione la descisión tomada" :disabled="edicion">
          <el-option label="Descisión 1" value="Descisión 1"></el-option>
          <el-option label="Descisión 2" value="Descisión 2"></el-option>
        </el-select>
    ...
    <el-button @click="msgEtapasVisible = true"
      style="margin-bottom:20px">Ingresar a las Etapas</el-button>
    ...
    <el-dialog title="Etapas" :visible.sync="msgEtapasVisible">
      ...
      <el-button size="mini" @click="msgEtapaVisible = true" :disabled="edicion">Agregar</el-button>
      ...
      style="width:100%">
        ...
        <el-table-column>
          ...
          <template slot-scope="scope">
            ...
            <el-button
              size="mini"
              @click="msgEtapaVisible = true;etapaEditar = scope.$index">Editar</el-button>

              <!-- Boton de eliminar -->
            <el-button
              size="mini"
              type="danger"
              @click="handleDelete(scope.$index, scope.row)">Quitar</el-button>
    ...
    <el-dialog title="Etapas" :visible.sync="msgEtapaVisible">
      ...
      <span slot="footer" class="dialog-footer">
        <el-button 
        @click="msgEtapaVisible = false">Cancelar</el-button>
        <el-button type="primary" 
        @click="msgEtapaVisible = false">Aceptar</el-button>
      </span>
