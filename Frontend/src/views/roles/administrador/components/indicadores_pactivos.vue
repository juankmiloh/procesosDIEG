<template>
  <div class="components-container">
		...
		<pie-chart
			:data="empresa"
			value-title="Cantidad de procesos activos por empresa"
		...
		<pie-chart
			:data="empresa"
			value-title="Cantidad de procesos activos por causal"
			v-model="chartGraficoFiltroFinalizados"
		/>
		...
		<pie-chart
			:data="empresa"
			value-title="Cantidad de procesos activos por etapa"
			v-model="chartGraficoFiltroFinalizados"
		/>
...
<script>
  ...
  export default {
		name: 'viewIndicadoresProcesosActivos',
